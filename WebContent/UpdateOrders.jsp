...
<title>Update Customer Orders</title>
  	...
  	<div class="container-fluid">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-4">
                        <h2> <b>Update Customer Order Details</b></h2>
                    </div>
                </div>
            </div>
            <br>
        ...
        <div class="login">
            <div class="container">
                <div class="login-form-grids">
                    <form method="post" action="UpdateOrders_db.jsp">
                        <input type="text" placeholder="Id" name="id" required="" >
                        <input type="email" placeholder="Email" name="email" required="" >
                        <input type="text" placeholder="Med Code" name="medcode" required="" >
                        ...
                        <input type="text" placeholder="Order Queue" name="orderqueue" required="" >
                        <input type="text" placeholder="Net Cost" name="netcost" required="" >
                        <input type="text" placeholder="Amount" name="amount" required="" >
                        <input type="text" placeholder="Paymode" name="paymode" required="" >
